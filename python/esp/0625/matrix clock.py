...
while 1:
    ...
    if r.status_code != 200:
        ...
        clock = data[
            'dt'] - 946684800  #(year-30,month,day,hour@UK,minute,seconds,weekdays,subseconds)
        ...
        clock_adjust = time.localtime(
            clock +
            28800)  # (year,month,day,weekday,hours,minutes,seconds,subseconds)
        rtc.datetime(clock_adjust[0:3] + (0, ) + clock_adjust[3:6] + (0, ))
        print('test: ', rtc.datetime()
              )  # (year,month,day,hours,minutes,seconds,weekdays,subseconds)
